      ...
      try:
                if antiSpam is True:
                 ...
                 #   if not punish_cd_bucket.update_rate_limit():
                      if data["punishment"] == "kick":
                        await message.author.kick(reason=f"Luka | Anti Spam")
                        hacker = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Kicked {message.author} For Spamming")
                      ...
                      if data["punishment"] == "ban":
                        await message.author.ban(reason=f"Luka | Anti Spam")
                        hacker1 = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Banned {message.author} For Spamming")
                      ...
                      if data["punishment"] == "none":
                        ...
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Luka | Anti Spam")
                        hacker2 = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Muted {message.author} For Spamming")
                ...
                if antiLink is True:
                    ...
                    if invite_matches:
                        ...
                        if data["punishment"] == "kick":
                            await message.author.kick(reason=f"Luka | Anti Discord Invites")
                            hacker3 = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Kicked {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "ban":
                            await message.author.ban(reason=f"Luka | Anti Discord Invites", delete_message_days=0)
                            hacker4 = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Banned {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "none":
                             now = discord.utils.utcnow()
                             await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Luka | Anti Discord Invites")
                             hacker5 = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Muted {message.author} For Sending Discord Server Invites")
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          await message.author.kick(reason="Luka | Anti Link") 
                          hacker6 = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Kicked {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "ban":
                          await message.author.ban(reason="Luka | Anti Link")  
                          hacker7 = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Banned {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "none":
                          now = discord.utils.utcnow()
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Luka | Anti Link")
                          hacker8 = discord.Embed(color=0x977FD7,description=f"<:check:1087776909246607360> | Successfully Muted {message.author} For Sending Links")
