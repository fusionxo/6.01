...
"Do a belly dance.",
"Join the Discord server  https://bit.ly/luka-support and ask for 5$."
...
class TD(commands.Cog):
    ...
    async def truth(self, ctx):
        embed = discord.Embed(description=random.choice(truth_norm), color=0x977FD7)
        user_name = str(ctx.author)
        embed.set_author(name=f"{user_name}", icon_url=ctx.author.avatar.url or "https://cdn.discordapp.com/attachments/1046001142057934939/1108093898179493928/LUKA.png")
        await ctx.send(embed=embed)
    
    @commands.command()
    async def dare(self, ctx):
        embed = discord.Embed(description=random.choice(dare_norm), color=0x977FD7)
        user_name = str(ctx.author)
        embed.set_author(name=f"{user_name}", icon_url=ctx.author.avatar.url or "https://cdn.discordapp.com/attachments/1046001142057934939/1108093898179493928/LUKA.png")
        await ctx.send(embed=embed)