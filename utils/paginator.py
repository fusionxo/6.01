...
class Paginator(discord.ui.View):
    ...
    def update_styles(self, **kwargs):
        ...
        self.first_page_button.label = None
        self.first_page_button.emoji = kwargs.get('first_button_emoji') or '<:bckwrd:1087776725443809290>'
        self.previous_page_button.label = None
        self.previous_page_button.emoji = kwargs.get(
            'previous_button_emoji') or '<:start:1087776654383919164>'
        self.next_page_button.label = None
        self.next_page_button.emoji = kwargs.get('next_button_emoji') or '<:eend:1087776923226210455>'
        self.last_page_button.label = None
        self.last_page_button.emoji = kwargs.get('last_button_emoji') or '<:fastfrwrd:1087776918637662249>'
        self.stop_button.emoji = kwargs.get(
            'stop_button_emoji') or '<:error:1088542929158688788>'
